...
namespace CompanyService
{
    ...
    public class CompanyService : ICompanyPublicService, ICompanyConfidentialService
    {
        ...
        {
            return "This is a public information and available to all general public outside the firewall";
        }

        public string GetConfidentialInformation()
        {
            return "This is a confidential information and available only over TCP inside the company firewall";
        }
    }
}
